 ...
 */
import type { RxJsonSchema, RxDocumentData, RxStorageChangeEvent, BulkWriteRow, RxAttachmentWriteData } from '../../types';
/**
 ...
 */
export type SharedWorkerMessageType = 'create' | 'close' | 'get' | 'getKeys' | 'bulkGet' | 'remove' | 'bulkRemove' | 'put' | 'bulkPut' | 'changeStream' | 'unsubscribeChangeStream' | 'cleanup' | 'query' | 'count' | 'getAll' | 'getByIds' | 'getAttachment' | 'getAttachmentBase64' | 'bulkAddAttachments';
/**
 ...
 */
export declare enum RxConflictResolutionStrategy {
