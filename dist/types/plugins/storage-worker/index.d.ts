...
export { getRxStorageWorker, RxStorageWorkerSettings, exposeWorkerRxStorage };
/**
 * Plugin that adds the Worker storage capabilities to RxDB
 */
export declare const RxDBWorkerStoragePlugin: {
    name: string;
    rxdb: boolean;
    overwritable: {
        createWorkerStorage: typeof getRxStorageWorker;
    };
};
