 ...
 */
import type { RxJsonSchema, RxStorageChangeEvent, BulkWriteRow, RxAttachmentWriteData } from '../../types';
/**
 ...
 */
export type WorkerMessageType = 'create' | 'close' | 'get' | 'getKeys' | 'bulkGet' | 'remove' | 'bulkRemove' | 'put' | 'bulkPut' | 'changeStream' | 'unsubscribeChangeStream' | 'cleanup' | 'query' | 'count' | 'getAll' | 'getByIds' | 'getAttachment' | 'getAttachmentBase64' | 'bulkAddAttachments';
/**
