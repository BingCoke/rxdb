import type { MangoQuery, RxDocumentData, RxJsonSchema, PreparedQuery } from '../../types/index.d.ts';
 ...
 * 查询修改器
 */
export type RxStorageSQLiteJSONQueryModifier<RxDocType> = (queryWithParams: SQLiteQueryWithParams, preparedQuery: SQLiteJSONPreparedQuery<RxDocType>) => SQLiteQueryWithParams;
/**
 * 实例创建选项
 */
