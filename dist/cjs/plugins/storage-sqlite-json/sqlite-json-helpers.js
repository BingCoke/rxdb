...
exports.TX_QUEUE_BY_DATABASE = exports.SQLITE_IN_MEMORY_DB_NAME = exports.RX_STORAGE_NAME_SQLITE_JSON = exports.PARAM_KEY = void 0;
exports.boolParamsToInt = boolParamsToInt;
exports.closeDatabaseConnection = closeDatabaseConnection;
exports.createJsonIndexSQL = createJsonIndexSQL;
exports.ensureParamsCountIsCorrect = ensureParamsCountIsCorrect;
exports.finishSqliteTransaction = finishSqliteTransaction;
exports.generateJsonPathExpression = generateJsonPathExpression;
exports.getDataFromResultRow = getDataFromResultRow;
exports.getDatabaseConnection = getDatabaseConnection;
exports.getSQLiteJSONInsertSQL = getSQLiteJSONInsertSQL;
exports.getSQLiteJSONUpdateSQL = getSQLiteJSONUpdateSQL;
exports.mangoQueryToSQLiteJSON = mangoQueryToSQLiteJSON;
exports.openSqliteTransaction = openSqliteTransaction;
exports.sqliteTransaction = sqliteTransaction;
var _index = require("../../index.js");
var RX_STORAGE_NAME_SQLITE_JSON = exports.RX_STORAGE_NAME_SQLITE_JSON = 'sqlite-json';
 ...
 * 生成SQLite插入SQL
 */
function getSQLiteJSONInsertSQL(collectionName, primaryPath, docData) {
  // language=SQL
 ...
 * 生成SQLite更新SQL
 */
function getSQLiteJSONUpdateSQL(tableName, primaryPath, writeRow) {
 ...
 */
function generateJsonPathExpression(path) {
  if (path.startsWith('$')) {
    return path;
  }
  return '$.' + path;
 ...
 * 支持单字段索引和联合索引
 */
function createJsonIndexSQL(tableName, fieldPath, indexName) {
 ...
 */
function mangoQueryToSQLiteJSON(fieldPath, operator, value) {
  // 处理空对象作为查询条件的特殊情况
