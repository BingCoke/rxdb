...
var RxStorageInstanceSQLiteJSON = exports.RxStorageInstanceSQLiteJSON = /*#__PURE__*/function () {
    ...
    Object.entries(selector).forEach(([field, condition]) => {
      ...
      if (typeof condition !== 'object' || condition === null) {
        var {
          sql,
          params: fieldParams
        } = (0, _sqliteJsonHelpers.mangoQueryToSQLiteJSON)(field, '$eq', condition);
        ...
        if (typeof condition === 'object' && condition !== null && Object.keys(condition).length === 0) {
          ...
          Object.entries(condition).forEach(([operator, value]) => {
            ...
            var {
              sql,
              params: opParams
            } = (0, _sqliteJsonHelpers.mangoQueryToSQLiteJSON)(field, operator, value);
            whereClauses.push(sql);
  ...
  _proto2.close = async function close() {
    ...
    this.closed = (async () => {
      ...
      await (0, _sqliteJsonHelpers.closeDatabaseConnection)(this.databaseName, this.storage.settings.sqliteBasics);
    })();
    return this.closed;
  };
...
async function createSQLiteJSONStorageInstance(storage, params, settings) {
  ...
  // 添加多实例支持
  await (0, _index.addRxStorageMultiInstanceSupport)(_sqliteJsonHelpers.RX_STORAGE_NAME_SQLITE_JSON, params, instance);
  return instance;
}
